package br.com.usbsystems.view;

import br.com.usbsystem.model.Address;
import br.com.usbsystem.model.Dev;

import java.util.Scanner;

public class ViewDev {
    ...
    private static Dev cadastrarProgramador() {
        Dev programador = new Dev();
        Scanner sc = new Scanner(System.in);
        System.out.println("Informe nome do programador: ");
        programador.setName(sc.nextLine());
        ...
        programador.setAddress(new Address(sc.nextLine(),
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (op){
                ...
                case 2:
                    if (programador != null)
                        System.out.println(programador.getDetalhe());
                    else
